...
class fdsLineTypes(object):
    ...
    def getDEVCtypes(self, version="6.7.4"):
        ...
        devcTypes['STATISTICS_END'] = 'float'
        ...
        devcTypes['XBP'] = 'listfloat'
        devcTypes['XYZ'] = 'listfloat'
        devcTypes['XYZ_UNITS'] = 'string'
        devcTypes['Y_ID'] = 'string'
    ...
    def getDUMPtypes(self, version="6.7.4"):
        ...
        dumpTypes['DT_SPEC'] = 'float'
        dumpTypes['DT_TMP'] = 'float'
        dumpTypes['DT_RESTART'] = 'float'
        dumpTypes['DT_UVW'] = 'float'
        dumpTypes['GET_CUTCELLS_VERBOSE'] = 'bool'
        dumpTypes['ID'] = 'ignore'
        dumpTypes['MASS_FILE'] = 'bool'
        dumpTypes['MMS_TIMER'] = 'float'
        dumpTypes['NFRAMES'] = 'int'
        dumpTypes['PLOT3D_QUANTITY'] = 'listind1string'
        dumpTypes['PLOT3D_SPEC_ID'] = 'listind1string'
        dumpTypes['RAMP_UVW'] = 'string'
        dumpTypes['RAMP_SMOKE3D'] = 'string'
        dumpTypes['RENDER_FILE'] = 'string'
        dumpTypes['RESULTS_DIR'] = 'string'
    ...
    def getMISCtypes(self, version="6.7.4"):
        ...
        miscTypes['NORTH_BEARING'] = 'float'
        miscTypes['NUCLEATION_SITES'] = 'int'
        miscTypes['ORIGIN_LAT'] = 'float'
        miscTypes['ORIGIN_LON'] = 'float'
    ...
    def getMULTtypes(self, version="6.7.4"):
        ...
        multTypes['DZ'] = 'float'
        multTypes['DZ0'] = 'float'
        multTypes['I_LOWER_SKIP'] = 'int'
        multTypes['I_LOWER'] = 'int'
        multTypes['I_UPPER_SKIP'] = 'int'
        multTypes['I_UPPER'] = 'int'
        multTypes['ID'] = 'string'
        multTypes['J_LOWER'] = 'int'
        multTypes['J_LOWER_SKIP'] = 'int'
        multTypes['J_UPPER'] = 'int'
        multTypes['J_UPPER_SKIP'] = 'int'
        multTypes['K_LOWER'] = 'int'
        multTypes['K_LOWER_SKIP'] = 'int'
        multTypes['K_UPPER'] = 'int'
        multTypes['K_UPPER_SKIP'] = 'int'
    ...
    def getOBSTtypes(self, version="6.7.4"):
        ...
        obstTypes['SURF_ID6'] = 'listind1string'
    ...
    def getPARTtypes(self, version="6.7.4"):
        ...
        partTypes['ORIENTATION'] = 'listind1float'
    ...
    def getSPECtypes(self, version="6.7.4"):
        ...
        specTypes['MASS_FRACTION'] = 'listind1float'
        ...
        specTypes['O'] = 'float'
        specTypes['RADCAL_ID'] = 'string'
        specTypes['RAMP_CP'] = 'string'
        specTypes['RAMP_K'] = 'string'
        specTypes['SPEC_ID'] = 'listind1string'
        ...
        specTypes['VOLUME_FRACTION'] = 'listind1float'
    ...
    def getSURFtypes(self, version="6.7.4"):
        ...
        surfTypes['CONVECTION_LENGTH_SCALE2'] = 'float'
        ...
        surfTypes['MASS_FLUX'] = 'listfloat'
        surfTypes['MASS_FLUX_TOTAL'] = 'float'
        surfTypes['MASS_FLUX_VAR'] = 'float'
        ...
        surfTypes['NUSSELT_IMP_C0'] = 'float'
        surfTypes['NUSSELT_IMP_C1'] = 'float'
        surfTypes['NUSSELT_IMP_C2'] = 'float'
        surfTypes['NUSSELT_IMP_M'] = 'float'
